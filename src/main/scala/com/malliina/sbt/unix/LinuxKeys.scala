...
trait LinuxKeys {
  ...
  val defaultsFile =
    settingKey[Path]("The defaults config file, installed to /etc/default/app_name_here")
  ...
  val httpsPort =
    settingKey[Option[String]]("https.port, cannot be 'disabled', use None to disable")
